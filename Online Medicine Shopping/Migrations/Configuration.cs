    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Online_Medicine_Shopping.DBContext.TemporaryDBContext>
    {
        ...
        protected override void Seed(Online_Medicine_Shopping.DBContext.TemporaryDBContext context)
        {
            ...
            context.users.AddOrUpdate(
                e => e.id,
                new Models.users { id = 1, username = "DonnaHall123", password = "Donna123456789", phone = "012222222", address = "test", type_id = 1, fullname = "Donna Hall", email = "Donna@gmail.com", image = "unknown.png" },
                new Models.users { id = 2, username = "JhonSmith222", password = "jhon123456789", phone = "012222222", address = "test", type_id = 1, fullname = "Jhon Smith Adam", email = "jhon@gmail.com", image = "unknown.png" },
                new Models.users { id = 3, username = "PeterAdam555", password = "peter123456789", phone = "012222222", address = "test", type_id = 2, fullname = "Peter Adam", email = "peter@gmail.com", image = "unknown.png" }
